-- Idempotent: only fills image_url where it is currently NULL or empty.
-- Safe to re-run.
...
UPDATE `services` SET `image_url` = 'https://images.unsplash.com/photo-1561070791-2526d30994b8?auto=format&fit=crop&w=800&q=70'
...
UPDATE `services` SET `image_url` = 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?auto=format&fit=crop&w=800&q=70'

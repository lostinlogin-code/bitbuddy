...
<div class="absolute inset-y-1 left-1 w-[calc(50%-4px)] bg-surface-variant/80 backdrop-blur-md border border-outline-variant/20 rounded-md shadow-sm pointer-events-none"></div>
<button class="flex-1 py-2 text-sm font-semibold text-primary z-10 relative focus:outline-none">
                    Вход
                </button>
<a class="flex-1 py-2 text-sm font-medium text-on-surface-variant hover:text-on-surface transition-colors duration-300 z-10 relative focus:outline-none text-center" href="register.php">
                    Регистрация
                </a>
</div>
<!-- Form -->
...
<input class="form-checkbox rounded bg-surface-container-lowest border-outline-variant/30 text-primary focus:ring-primary focus:ring-offset-background h-4 w-4 transition-colors" type="checkbox"/>
<span class="ml-2 text-on-surface-variant group-hover:text-on-surface transition-colors">Запомнить меня</span>
</label>
<a class="text-primary hover:text-primary-dim transition-colors hover:drop-shadow-[0_0_8px_var(--color-primary)]" href="contacts.php">Забыли пароль?</a>
</div>
<!-- Submit Button -->
...
<div class="absolute inset-x-0 h-px bg-gradient-to-r from-transparent via-outline-variant/30 to-transparent"></div>
<span class="relative bg-surface-variant px-4 text-xs text-on-surface-variant tracking-wider uppercase backdrop-blur-md rounded-full border border-outline-variant/15">или</span>
</div>
<button class="w-full flex items-center justify-center gap-3 py-3 px-6 bg-surface-container-lowest/50 border border-outline-variant/15 rounded-xl text-sm font-medium text-on-surface-variant/50 cursor-not-allowed" type="button" disabled title="Скоро будет доступно">
